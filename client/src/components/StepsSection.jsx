...
const StepsSection = () => {
  return (
    <div className='flex flex-col md:flex-row md:items-stretch items-center justify-between px-6 lg:px-10 py-16 bg-[#6366F1] max-w-6xl mx-auto rounded-3xl overflow-hidden relative bg-[url("./assets/tire_track.png")] bg-no-repeat bg-cover bg-center'>
      <div className='w-full lg:w-full flex flex-col gap-8 text-white relative z-10'>
        ...
        <div className='flex items-start gap-4'>
          <div className='flex items-center justify-center w-8 h-8 rounded-full bg-orange-500 text-white font-semibold flex-shrink-0'>1</div>
          <div>
        ...
        <div className='flex items-start gap-4'>
          <div className='flex items-center justify-center w-8 h-8 rounded-full bg-orange-500 text-white font-semibold flex-shrink-0'>2</div>
          <div>
        ...
        <div className='flex items-start gap-4'>
          <div className='flex items-center justify-center w-8 h-8 rounded-full bg-orange-500 text-white font-semibold flex-shrink-0'>3</div>
          <div>
        ...
        <div className='flex items-start gap-4'>
          <div className='flex items-center justify-center w-8 h-8 rounded-full bg-orange-500 text-white font-semibold flex-shrink-0'>4</div>
          <div>
